...
void main() {
	int i, a, b, c, index = 0;//index´Â ¹è¿­ µ¥ÀÌÅÍ°¡ ¾îµð¸¦ Ç¥ÇöÇØ¾ß ÇÒÁö ¾Ë·ÁÁÙ À§Ä¡
	char keyboard_value;
	...
	struct food_category banchan = { {10}, "¼Ò°í±âÀåÁ¶¸²","¸êÄ¡ººÀ½","¹ÝÂù1","¹ÝÂù2","¹ÝÂù3","¹ÝÂù4","¹ÝÂù5","¹ÝÂù6","¹ÝÂù7","¹ÝÂù8","¹ÝÂù9" };
